  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-xl w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-gray-100 text-center">
        ...
        <h2 className="mt-6 text-center text-3xl font-semibold text-navy-900 ">
          ORD-SUCCESSFUL
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          <Link
            href="/"
            className="flex-1 px-8 py-4 bg-navy-950 text-white rounded-2xl font-semibold text-xs  tracking-widest hover:bg-brand-600 transition-all flex items-center justify-center gap-2"
          >
            <Package size={18} /> Continue Shopping
          </Link>
          <button className="flex-1 px-8 py-4 bg-gray-100 text-gray-700 rounded-2xl font-semibold text-xs  tracking-widest hover:bg-gray-200 transition-all flex items-center justify-center gap-2">
