          ...
          <div className="bg-navy-950 p-12 md:p-20 text-center relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-slate-400 max-w-xl mx-auto font-medium text-lg leading-relaxed">
                Every device purchased through{" "}
                {siteConfig?.business_name || "Trimurti"} is protected by our
                industry-leading comprehensive protection plan.
              </p>
            </div>
              ...
              {[
                {
                  icon: ShieldCheck,
                  title: "Full Coverage",
                  desc: "Covers all manufacturing defects and internal hardware failures for 12 months.",
                },
                {
                  icon: RefreshCw,
                  title: "Instant Replacement",
                  desc: "If we can&apos;t fix it, we replace it with a new unit within 48 hours of verification.",
                },
                {
                  icon: Clock,
                  title: "Priority Support",
                  desc: "Elite program members get 24/7 direct access to lead hardware engineers.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="p-10 bg-gray-50 rounded-[2.5rem] border border-gray-100 hover:border-brand-200 hover:bg-white hover:shadow-2xl transition-all duration-500 text-center"
                >
                  ...
                  <>
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-gray-500 font-medium">
                        ...
                        (drops/spills), but can be upgraded to Elite Plus Care.
                      </p>
                    </div>
                    <div className="space-y-4">
                      <h4 className="font-bold text-navy-950">
                      ...
                      <p className="text-sm text-gray-500 font-medium">
                        All products are automatically registered to your
