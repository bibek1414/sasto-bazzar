                        ...
                        <div className="space-y-8 relative z-10">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a href={`mailto:${siteConfig?.email || 'support@SastoBazzar.com'}`} className="text-white font-medium hover:text-brand-300 transition-colors">
                                        {siteConfig?.email || 'support@SastoBazzar.com'}
                                    </a>
                                </div>
                            </div>
