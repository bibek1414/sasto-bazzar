...
const Brands: React.FC = () => {
  ...
  return (
    <div className="py-20 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4">
        <p className="text-center text-xs font-semibold text-gray-400  tracking-[0.3em] mb-12">
          Authorized Excellence Partner
        </p>
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-40 hover:opacity-100 transition-opacity grayscale hover:grayscale-0 duration-700">
          {clients.map((client) => (
            <div
              key={client.id}
              className="relative h-6 md:h-8 w-24 md:w-32 transition-transform hover:scale-110 grayscale hover:grayscale-0 duration-300"
            >
              <Image
