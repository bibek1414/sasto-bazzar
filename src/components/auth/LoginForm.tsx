      ...
      <div className="max-w-md w-full space-y-8 bg-card p-10 rounded-3xl shadow-xl shadow-secondary/50 border border-border/50">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full bg-primary hover:bg-primary/90 text-primary-foreground py-6 rounded-xl  text-lg shadow-lg shadow-primary/10 transition-all active:scale-[0.98] disabled:opacity-50"
          >
