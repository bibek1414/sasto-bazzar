    ...
    <div className="bg-gray-50 rounded-[3rem] p-8 md:p-16 flex flex-col lg:flex-row items-center gap-12 overflow-hidden relative border border-gray-100">
      <div className="flex-1 relative z-10">
        ...
        <p className="text-slate-500 font-medium max-w-md">
          Get priority access to limited edition drops, specialized hardware
          insights, and exclusive member pricing.
        </p>
      </div>
      ...
      <div className="w-full lg:w-[450px] relative z-10">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isPending}
            className="bg-navy-950 text-white px-8 py-4 rounded-2xl font-semibold  tracking-widest text-xs hover:bg-brand-600 transition-all shadow-xl flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed min-w-[120px]"
          >
            {isPending ? (
