    ...
    <div className="fixed inset-0 z-[60] lg:hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-80 bg-card shadow-2xl flex flex-col">
        ...
        <div className="flex-1 p-4 overflow-y-auto space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              {isFiltering && (
                <Loader2 className="absolute w-4 h-4 text-primary right-3 top-3 animate-spin" />
              )}
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full p-2 text-sm border border-border/50 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none bg-background text-foreground"
                  />
                </div>
                <div className="space-y-1">
                  <span className="text-[10px] text-muted-foreground font-bold ">
        ...
        <div className="p-4 border-t border-border/50 bg-secondary/30">
          ...
          {isFiltering && (
            <div className="flex items-center justify-center gap-2 text-[10px] text-primary font-bold  tracking-widest pt-3">
