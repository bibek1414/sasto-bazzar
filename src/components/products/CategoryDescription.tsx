  ...
  return (
    <div className="mt-20 py-16 border-t border-gray-100">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-sm font-semibold text-primary  tracking-[0.3em] mb-6">
        ...
        <p className="mt-10 text-xs font-bold text-gray-400  tracking-widest leading-loose max-w-2xl mx-auto">
          Our {category.name} collection is curated with an unwavering
          commitment to quality and aesthetics. Each piece tells a story of
          heritage, innovation, and the pursuit of perfection.
        </p>
      </div>
    </div>
  );
